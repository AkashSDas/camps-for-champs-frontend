    ...
    <IconWrapper {...props}>
      <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          d="M2.25 7C2.25 4.37665 4.37665 2.25 7 2.25H17C19.6234 2.25 21.75 4.37665 21.75 7V17C21.75 19.6234 19.6234 21.75 17 21.75H7C4.37665 21.75 2.25 19.6234 2.25 17V7ZM7 3.75C5.20507 3.75 3.75 5.20507 3.75 7V8.07353H11.25V3.75H7ZM12.75 3.75V8.07353H20.25V7C20.25 5.20507 18.7949 3.75 17 3.75H12.75ZM20.25 9.57353H12.75V14.4265H20.25V9.57353ZM20.25 15.9265H12.75V20.25H17C18.7949 20.25 20.25 18.7949 20.25 17V15.9265ZM11.25 20.25V15.9265H3.75V17C3.75 18.7949 5.20507 20.25 7 20.25H11.25ZM3.75 14.4265H11.25V9.57353H3.75V14.4265Z"
        />
      </svg>
    </IconWrapper>
  );
